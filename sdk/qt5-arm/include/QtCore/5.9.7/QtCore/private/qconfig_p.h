/* qconfig_p.h - Private Qt configuration for ARM cross-compilation */
/* Generated for Qt 5.9.7 ARM webOS build */

#ifndef QCONFIG_P_H
#define QCONFIG_P_H

/* CPU/Architecture features - ARM specific, no x86 features */
